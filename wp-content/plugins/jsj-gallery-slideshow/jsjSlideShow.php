...
class JSJGallery{
	...
	*/
	...
	public function jsj_gallery_gallery_shortcode($attr){
		...
		$gallery_div = "<div id='galleryid-{$instance}' data-total='{$totalCount}'class='gallery gallery_jsjss galleryid-{$id} gallery-columns-{$columns} gallery-size-{$size_class}'>";
	...
	public function jsj_slide_add_init_function(){
		...
		jQuery(document).ready(function(){
			jQuery('.gallery_jsjss').each(function(index){
